...
if (isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['email']) && isset($_POST['mobile']) && isset($_POST['dob'])&&isset($_POST['pin'])) 
{
    ...
    $stmt = $pdo->prepare("
        INSERT INTO profile (profile_id, first_name, last_name, email, mobile, dob,pin)
        VALUES (:profile_id, :first_name, :last_name, :email, :mobile, :dob,:pin)
    ");
        ...
        <div class="container">
            ...
            <form method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input pattern="[0-9]{10}"class="form-control" type="text" name="mobile" id="mobile">
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="dob">Date of birth:</label>
                    <div class="col-sm-5">
                        <input type="date" class="form-control" name="dob" id="dob" ></textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label class="control-label col-sm-2" for="pin">Pin Code:</label>
                    <div class="col-sm-5">
                        <input pattern="[0-9]{6}" class="form-control" name="pin" id="pin" ></textarea>
                    </div>
                </div>
                <div class="form-group">
